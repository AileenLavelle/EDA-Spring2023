...
ozone.density <- ggplot(EPAair, aes(x = Ozone, fill=as.factor(Year))) +
  ...
  labs(x="Ozone AQI Value", y="Denisity", fill= "")
print(ozone.density)
#2 box-plot
...
Ozone.PM2.5 <- lm(data = EPAair, Ozone ~ PM2.5)
summary(Ozone.PM2.5) 
...
summary(Ozone.Best)
#including year does not increase the r-squared variable and makes the model more complicated but not better.
```
