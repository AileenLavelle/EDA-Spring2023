...
ggplot(EPAair, aes(x = Date, y = Ozone)) + 
  geom_point()
#another way to make the same plot but in different way
O3plot <- ggplot(EPAair) +
  geom_point(aes(x = Date, y = Ozone))
print(O3plot)

# Fix this code
#change all the points to be blue, the color needs to be outside the parentheses
...
#chnage the shape based on year and color as a function of sitename
PMplot <- 
...
#scatterplot, trendline and smooth
NvsP <-
...
#color is the contour of the shape and fill is the fill of the box plot but outline remains black
print(Nutrientplot3)
