...
#if the groups have the same letter than they are the same mean
...
> The graph shows all the sites that have the same means We would want to reorder the lists of sites, from least to most.
...
# Format as lm
#means are different among the different sites, same result as before
