...
#Set the URL
URL2 <- 'https://waterdata.usgs.gov/nwis/uv?search_site_no=02085070&period=4&format=rdb'

#Get the data, which starts on line 30
gage_data2 <- read.table(URL2,skip = 29,header=TRUE,sep='\t',stringsAsFactors = T) 
