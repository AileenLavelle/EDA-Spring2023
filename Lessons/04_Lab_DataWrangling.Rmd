...
class(NTL.nutrient.data$year4)
#integer, we had to use ==

# Exercise 2: 
# filter NTL.phys.data for Tuesday Lake from 1990 through 1999.
NTL.Nutrient.TuesdayLake.90s <- filter(NTL.phys.data, year4 > 1989 & year4 < 2000 & lakename == "Tuesday Lake")
=======
# what code do you need to use, based on the class of the variable?
...
<<<<<<< HEAD
NTL.phys.Mean.Tuesday.July.1990s <-
  NTL.phys.Tuesday.July.1990s %>% 
  filter(depth == 0) %>%
...
<<<<<<< HEAD
#must cite the original data set's cloumn names
NTL.phys.Irradiance <-
  NTL.phys.data %>%
